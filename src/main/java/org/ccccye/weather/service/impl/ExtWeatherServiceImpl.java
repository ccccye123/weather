...
@Service
public class ExtWeatherServiceImpl implements ExtWeatherService {
    private final static Log logger = LogFactory.getLog(ExtWeatherServiceImpl.class);
